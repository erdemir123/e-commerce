...
export default function SideBar() {
  ...
  return (
    <div
      ...
      } relative  flex justify-center transition-all duration-1500 bg-slate-200 text-slate-950 shadow-lg shadow-slate-900`}
    >
      <div
        onClick={() => {
      ...
      <div className="flex flex-col justify-center items-center absolute bottom-0  mx-auto group bg-slate-200 w-full py-2">
        {session && (
